...
<div class="w3-content w3-container w3-padding-64" id="about">
  ...
  <div class="textbubble"> 
    <ul class="word-cloud" role="navigation" aria-label="Psychologie & Spiritualität Word Cloud">
      <li><a href="#" class="word" data-weight="5">Achtsamkeit</a></li>
      <li><a href="#" class="word" data-weight="8">Meditation</a></li>
      <li><a href="#" class="word" data-weight="7">Selbstreflexion</a></li>
      <li><a href="#" class="word" data-weight="9">Bewusstsein</a></li>
      <li><a href="#" class="word" data-weight="4">Karma</a></li>
      <li><a href="#" class="word" data-weight="6">Empathie</a></li>
      <li><a href="#" class="word" data-weight="3">Resilienz</a></li>
      <li><a href="#" class="word" data-weight="5">Loslassen</a></li>
      <li><a href="#" class="word" data-weight="7">Ego</a></li>
      <li><a href="#" class="word" data-weight="2">Intuition</a></li>
      <li><a href="#" class="word" data-weight="6">Traumarbeit</a></li>
      <li><a href="#" class="word" data-weight="4">Chakren</a></li>
      <li><a href="#" class="word" data-weight="8">Seelenheil</a></li>
      <li><a href="#" class="word" data-weight="5">Schwingung</a></li>
      <li><a href="#" class="word" data-weight="9">Energiefluss</a></li>
      <li><a href="#" class="word" data-weight="3">Erleuchtung</a></li>
      <li><a href="#" class="word" data-weight="4">Schattenarbeit</a></li>
      <li><a href="#" class="word" data-weight="7">Manifestation</a></li>
      <li><a href="#" class="word" data-weight="2">Synchronicität</a></li>
      <li><a href="#" class="word" data-weight="6">Innere Ruhe</a></li>
      <li><a href="#" class="word" data-weight="3">Seelenreise</a></li>
      <li><a href="#" class="word" data-weight="5">Selbstliebe</a></li>
      <li><a href="#" class="word" data-weight="9">Spiritualität</a></li>
      <li><a href="#" class="word" data-weight="4">Transzendenz</a></li>
      <li><a href="#" class="word" data-weight="6">Metaphysik</a></li>
      <li><a href="#" class="word" data-weight="8">Unterbewusstsein</a></li>
      <li><a href="#" class="word" data-weight="2">Glaubenssätze</a></li>
      <li><a href="#" class="word" data-weight="7">Inneres Kind</a></li>
      <li><a href="#" class="word" data-weight="3">Dankbarkeit</a></li>
      <li><a href="#" class="word" data-weight="5">Selbsterkenntnis</a></li>
      <li><a href="#" class="word" data-weight="4">Harmonie</a></li>
      <li><a href="#" class="word" data-weight="6">Lichtarbeit</a></li>
      <li><a href="#" class="word" data-weight="8">Seelenverwandte</a></li>
      <li><a href="#" class="word" data-weight="3">Vergebung</a></li>
      <li><a href="#" class="word" data-weight="7">Transformation</a></li>
      <li><a href="#" class="word" data-weight="9">Seinszustand</a></li>
      <li><a href="#" class="word" data-weight="4">Frequenz</a></li>
      <li><a href="#" class="word" data-weight="5">Universum</a></li>
      <li><a href="#" class="word" data-weight="2">Luzides Träumen</a></li>
    </ul>
  </div>
</div>
</div>
...
<footer class="w3-center w3-black w3-padding-64 w3-opacity w3-hover-opacity-off">
  ...
  <script type="module">
    ...
    import { getFirestore, doc, getDoc, setDoc, updateDoc, getDocs, collection } from "https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";

    // Firebase-Konfiguration (ersetze mit deiner eigenen Konfiguration)
    ...
    document.addEventListener('DOMContentLoaded', function() {
      // Holen der Wortgrößen von Firestore (falls vorhanden)
      const wordCloudDiv = document.getElementById("wordCloud");
      
      // Firestore-Daten abrufen
      getDocs(collection(db, "wordCounts")).then((querySnapshot) => {
        querySnapshot.forEach((doc) => {
          const wordData = doc.data();
          document.querySelectorAll(`.word[data-word="${wordData.word}"]`).forEach(link => {
            link.style.fontSize = `${wordData.count + 1}rem`;
          });
        });
      });

      // Event Listener für Klicks auf die Wörter
      ...
      wordLinks.forEach(link => {
        link.addEventListener('click', function(e) {
          ...
          // WordCount in Firestore erhöhen
          const wordRef = doc(db, 'wordCounts', word);
          getDoc(wordRef).then(docSnapshot => {
            if (docSnapshot.exists()) {
              const currentCount = docSnapshot.data().count;
              updateDoc(wordRef, { count: currentCount + 1 }).then(() => {
                // Klick erfolgreich gespeichert, Wortgröße aktualisieren
                link.style.fontSize = `${currentCount + 2}rem`;
              });
            } else {
              // Wenn das Wort noch nicht existiert, erstelle ein neues Dokument
              setDoc(wordRef, { word: word, count: 1 }).then(() => {
                link.style.fontSize = '2rem'; // Initiale Größe
              });
            }
          });
        });
